...
export async function POST(request: Request) {
  try {
    ...
    } else if (data.formType === "entrance_test") {
      if (!submissions.entranceTestResults) submissions.entranceTestResults = [];
      submissions.entranceTestResults.push(newSubmission);
    } else {
