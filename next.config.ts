...
try {
  ...
  // Copy all assets from the brain folder to public/images and app folders if local brain folder exists
  ...
  console.error("Initialization error in next.config.ts:", globalError);
}
